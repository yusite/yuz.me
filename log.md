...
<br>
<select name="create" id="recent" style="font-size:16px;margin-top:10px;width:185px;">
<option selected value="">快速添加</option>
</select>
<br>
<input type="text" name="create" style="font-size:18px;margin-top:6px;width:185px;" placeholder="name">
<br>
